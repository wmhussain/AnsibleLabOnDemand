...
curl -k -H "Content-Type: application/json" -X POST -u admin:$p -d '{"username": "labuser", "first_name": "labuser", "last_name": "labuscurl -k -H "Content-Type: application/json" -X POST -u admin:$p -d 'er", "email": "labuser@labuser.com", "is_superuser": false, "is_system_auditor": false, "password": "$4"}' $url1
